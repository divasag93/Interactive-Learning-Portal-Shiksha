    ...
    public partial class Lectures : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                while (dr.Read())
                {
                    string s1 = Server.MapPath("Shiksha" + "\\" + ss[0] + "\\" + ss[1] + "\\Lectures");
                    ...
                    foreach (FileInfo ff in fi)
                    {
                        ...
                        lecture.Controls.Add(l);
                       lecture.Controls.Add(new LiteralControl("<br>"));
        ...
        protected void MyClick(object sender, EventArgs e)
        {
            ...
            string s = r.brsem(Session["studentid"].ToString());
            string[] ss = s.Split('.');
            String str1 = Server.MapPath("Shiksha" + "\\" + ss[0] + "\\" + ss[1] + "\\Lectures" + "\\" + l.CommandName);
