<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviousResult.aspx.cs" Inherits="Interactive_Learning_Portal.PreviousResult" %>
...
<head>
	...
	<body>
		...
		<div class="main-banner seven">
			<div class="container">
				<h2><span>Previous Result</span></h2>
			</div>
		</div>
	<!-- Main Banner Ends -->
	<!-- Breadcrumb Starts -->
		<div class="breadcrumb">
			<div class="container">
				<ul class="list-unstyled list-inline">
                    ...
                    <li class="active">Previous Result</li>
				</ul>
			</div>
		</div>		
		<div class="container main-container">
            <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12 newsletter-block" id="result" runat="server">
