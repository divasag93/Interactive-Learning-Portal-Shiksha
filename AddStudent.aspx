<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStudent.aspx.cs" Inherits="Interactive_Learning_Portal.AddStudent" %>
...
<head>
	...
	<body>
		...
		<div class="main-banner three">
			<div class="container">
				<h2><span>Admin- Add Student</span></h2>
			</div>
		</div>
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-12 col-sm-12">
									<div class="form-group">
										<label>Name </label>
										<input type="text" class="form-control" pattern="(?=.*[a-z])(?=.*[A-Z]).{2,}" placeholder="Enter Name" id="name" runat="server" required="required">
									</div>
								</div>
								...
								<div class="col-md-6 col-xs-12 col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" pattern="(?=.*[a-z])(?=.*[A-Z]).{2,}"  id="fname" runat="server" placeholder="Enter Father's Name" required="required">
									</div>
								</div>
								...
								<div class="col-md-6 col-xs-12 col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" pattern="(?=.*[a-z])(?=.*[A-Z]).{2,}"  id="mname" runat="server" placeholder="Enter Mother's Name" required="required">
									</div>
								</div>
								...
								<div class="col-md-6 col-xs-12 col-sm-12">
									<div class="form-group">
										<label>Course </label>
										<input type="text" class="form-control" disabled="disabled" value="B.Tech"  id="course" runat="server" required="required">
									</div>
								</div>
