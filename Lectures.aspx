<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lectures.aspx.cs" Inherits="Interactive_Learning_Portal.Lectures" %>
			...
			<!-- Tab Content Starts -->
				...
				<!-- Tab #1 Starts -->
					<div class="tab-pane fade in active" id="tab-1">
						<div class="row">
					<div class="col-md-12 col-xs-12 col-sm-12" id="lecture" runat="server">
